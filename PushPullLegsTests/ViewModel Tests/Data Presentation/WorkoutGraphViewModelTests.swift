...
//        sut = WorkoutGraphViewModel(type: .push, dataManager: WorkoutDataManager(context: dbHelper.coreDataStack.backgroundContext))
//        XCTAssert(sut.title() == ExerciseType.push.rawValue)
//        sut = WorkoutGraphViewModel(type: .pull, dataManager: WorkoutDataManager(context: dbHelper.coreDataStack.backgroundContext))
//        XCTAssert(sut.title() == ExerciseType.pull.rawValue)
//        sut = WorkoutGraphViewModel(type: .legs, dataManager: WorkoutDataManager(context: dbHelper.coreDataStack.backgroundContext))
